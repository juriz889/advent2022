...
class PriorityCounterTest {
    ...
    @Test
    void input_findPriority_priority147() {
        PriorityCounter cut = new PriorityCounter();
        String input = """
        ...
        int priority = cut.findPriority(input);
        assertThat(priority).isEqualTo(157);
    }

    @Test
    void puzzle_findPriority_priority147() {
        PriorityCounter cut = new PriorityCounter();
        String input = """
        ...
        int priority = cut.findPriority(input);
        assertThat(priority).isEqualTo(8240);
    }

    @Test
    public void batchesMissing_findBatches_batchFound() {
        PriorityCounter cut = new PriorityCounter();
        String input = """
                vJrwpWtwJgWrhcsFMMfFFhFp
                jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL
                ...
                ttgJtRGJQctTZtZT
                CrZsJsPPZsGzwwsLwLmpwMDw""";
        int batchSize = cut.findBatches(input);
        assertThat(batchSize).isEqualTo(70);
    }

    @Test
    public void batchPuzzle_find_batchFound() {
        PriorityCounter cut = new PriorityCounter();
        String input = """
                pqgZZSZgcZJqpzBbqTbbLjBDBLhB
                wHptFFsHttHFLMDQDFTbbj
                ...
                VqLtFCqFJfVtVjsNgPNNMMWNwgtNvn""";
        int batchSize = cut.findBatches(input);
        assertThat(batchSize).isEqualTo(2587);
    }
}