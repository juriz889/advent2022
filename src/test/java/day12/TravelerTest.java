...
class TravelerTest {
    @Test
    public void sampleInput_countLeastTravers_31() {
        String input = """
                Sabqponm
                abcryxxl
                accszExk
                acctuvwj
                abdefghi""";
        Traveler cut = new Traveler();
        int leastTravel = cut.getLeastTravels(input);
        assertThat(leastTravel).isEqualTo(31);
    }

    @Test
    public void sampleInput_countLeastTraversFromA_29() {
        String input = """
                Sabqponm
                abcryxxl
                accszExk
                ...
                abdefghi""";
        Traveler cut = new Traveler();
        int leastTravel = cut.getLeastTravelsFromA(input);
        assertThat(leastTravel).isEqualTo(29);
    }

    @Test
    public void puzzleInput_countLeastTravers_468() {
        String input = """
        ...
        Traveler cut = new Traveler();
        int leastTravel = cut.getLeastTravels(input);
        assertThat(leastTravel).isEqualTo(468);
    }

    @Test
    public void puzzleInput_countLeastTravers29_468() {
        String input = """
                
        ...
        Traveler cut = new Traveler();
        int leastTravel = cut.getLeastTravelsFromA(input);
        assertThat(leastTravel).isEqualTo(459);
    }
}