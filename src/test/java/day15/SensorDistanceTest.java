...
class SensorDistanceTest {
    @Test
    void sampleInput_calc_26() {
        String input = """
                ...
                Sensor at x=20, y=1: closest beacon is at x=15, y=3
                                """;
        SensorDistance cut = new SensorDistance();
        int i = cut.calcPossibleBeacons(input, 10);
        assertThat(i).isEqualTo(26);
    }

    @Test
    void puzzleInput_calc_26() {
        String input = """
                ...
                Sensor at x=3818789, y=2961752: closest beacon is at x=3629407, y=2984857
                                                """;
        SensorDistance cut = new SensorDistance();
        int i = cut.calcPossibleBeacons(input, 2000000);
        assertThat(i).isEqualTo(26);
    }
}